...
public class AddDeviceActivity extends AppCompatActivity implements MQTTService.MQTTCallback {
    ...
    private static final String TOPIC = "/phone/notification";
    ...
    private void toggleLight() {
        isLightOn = !isLightOn;
        updateUI();
        mqttService.publish(TOPIC, isLightOn ? "on" : "off", MqttQos.AT_LEAST_ONCE);
    }

    private void updateUI() {
//        if (isLightOn) {
//            lightImageView.setImageResource(R.drawable.ic_light_on);
//            statusTextView.setText("Light: ON");
//            toggleButton.setText("Turn OFF");
//            toggleButton.setBackgroundTintList(getResources().getColorStateList(android.R.color.holo_red_light));
//        } else {
//            lightImageView.setImageResource(R.drawable.ic_light_off);
//            statusTextView.setText("Light: OFF");
//            toggleButton.setText("Turn ON");
//            toggleButton.setBackgroundTintList(getResources().getColorStateList(android.R.color.holo_green_light));
//        }
    }
...
//                    isLightOn = false;
//                }
//                updateUI(); // Cập nhật giao diện dựa trên message nhận được
//            }
//        });
    }
...
//        runOnUiThread(() -> statusTextView.setText("Connection lost: " + cause.getMessage()));
    }

    @Override
    public void onConnected() {
        mqttService.subscribe(TOPIC, MqttQos.AT_LEAST_ONCE);
//        runOnUiThread(() -> statusTextView.setText("Connected, Light: OFF"));
    }
...
//        // Thêm sự kiện cho nút btn_new_custom
